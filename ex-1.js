...
//they don't reference the same object in memory
...
3.14 !== 3.14;  //false
"TechUp" !== "TechUp";  //false
NaN === NaN;  // false   NaN identified the unexpected
0 !== -0;  //false  different sign

let objectA = { course: "Web Developer", price: 300000 };
let objectB = { course: "Web Developer", price: 300000 };
objectA === objectB;  //false   different memory
